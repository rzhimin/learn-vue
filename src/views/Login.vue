  ...
  <div class="login-wrap" style="background-color: #fff">
    ...
    <div class="login-form">
      ...
      <div class="change-type-wrap">
        <span class="item" :class="{ active: loginType == 1 }" @click="loginType = 1">账户密码登录</span>
        <span class="item" :class="{ active: loginType == 2 }" @click="loginType = 2">手机号登录</span>
        <span class="under-line" ref="type"></span>
      </div>
      <!-- 账号密码 -->
      <div class="password-login-form" v-show="loginType == 1">
        <div class="input-item">
          <input type="text" placeholder="账号" onfocus="this.placeholder = ''" onblur="this.placeholder = '账户'" />
          <div class="input-text">账户</div>
          <span class="icon account"></span>
        </div>
        <div class="input-item">
          <input type="text" placeholder="密码" onfocus="this.placeholder = ''" onblur="this.placeholder = '密码'" />
      ...
      <div class="phone-verify-form" v-show="loginType == 2">
        ...
        <div class="input-item">
          ...
          <span class="send-code-btn" :class="{ disabled: countdown < 60 }" @click="sendVerifyCode()">{{
            sendCodeText
          }}</span>
      ...
      <div class="auto-login-forget">
        <span class="check-box" @click="rememberPassword = !rememberPassword">
          <img src="../../assets/img/login/uncheck.png" v-show="!rememberPassword" />
          <img src="../../assets/img/login/checked.png" v-show="rememberPassword" />
          自动登录
        </span>
...
.login-wrap {
  ...
  .login-form {
    ...
    animation: showLeft 0.8s linear forwards, twinkling 2s linear infinite alternate;
